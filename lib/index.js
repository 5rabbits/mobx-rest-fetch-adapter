...
function ajaxOptions(options) {
  var HeadersConstructor = Headers;
  ...
  if (typeof HeadersConstructor === 'undefined') {
    HeadersConstructor = (0, _fetchPonyfill2.default)().Headers;
  }
  ...
  var headersObject = new HeadersConstructor(Object.assign(baseHeaders, headers));
...
function ajax(url, options) {
  ...
  if (options.method === 'GET' && options.data) {
    url = url + '?' + _qs2.default.stringify(options.data, options.qsOptions);
    delete options.data;
  }

  if (typeof fetchMethod === 'undefined') {
    fetchMethod = (0, _fetchPonyfill2.default)().fetch;
  }

  var xhr = fetchMethod(url, ajaxOptions(options));
...
exports.default = {
  ...
  get: function get(path, data) {
    ...
    return ajax('' + this.apiPath + path, (0, _lodash2.default)({}, { method: 'GET' }, this.commonOptions, options, { data: data }));
  },
  post: function post(path, data) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    return ajax('' + this.apiPath + path, (0, _lodash2.default)({}, { method: 'POST' }, this.commonOptions, options, { data: data }));
  },
  put: function put(path, data) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    return ajax('' + this.apiPath + path, (0, _lodash2.default)({}, { method: 'PUT' }, this.commonOptions, options, { data: data }));
  },
  del: function del(path) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return ajax('' + this.apiPath + path, (0, _lodash2.default)({}, { method: 'DELETE' }, this.commonOptions, options));
  }
};